...
@misc{rocheteau2020temporal,
      ...
      author={Emma Rocheteau and Pietro Lio and Stephanie Hyland},
      year={2020},
      eprint={2007.09483},
      archivePrefix={arXiv},
      primaryClass={cs.LG}
...
I am planning to also implement a version of the TPC model that can simply be plugged into the Harutyunyan et al. pipeline.
