...
if __name__=='__main__':
    ...
    parser.add_argument('--L2_regularisation', default=0.01, type=float)
    parser.add_argument('--lstm_dropout_rate', default=0.3, type=float)
    parser.add_argument('--main_dropout_rate', default=0.3, type=float)
    parser.add_argument('--learning_rate', default=0.0001, type=float)
    parser.add_argument('--hidden_size', default=128, type=int)
    parser.add_argument('--n_layers', default=2, type=int)
    parser.add_argument('--diagnosis_size', default=25, type=int)
    ...
    parser.add_argument('--last_linear_size', default=25, type=int)
