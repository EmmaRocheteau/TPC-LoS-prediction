...
if __name__=='__main__':
    ...
    parser.add_argument('--exp_name', default='PointwiseOnlyNoDecay', type=str)
    parser.add_argument('--n_epochs', default=15, type=int)
    parser.add_argument('--batch_size_test', default=64, type=int)
    parser.add_argument('--model_type', default='pointwise_only', type=str)
    ...
    c['n_layers'] = 9
    c['kernel_size'] = 4
    c['temp_kernels'] = [12]*c['n_layers']  # doesn't actually use this
